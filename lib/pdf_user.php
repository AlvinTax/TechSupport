...
$pdf->Image('../img/main/slider01.jpg',40,10,-300);
$pdf->Cell (0,5,utf8_decode('TechSupport Guatemala'),0,1,'C');
$pdf->Cell (0,5,utf8_decode('Reporte de problema mediante Tracking ID'),0,1,'C');
...
$pdf->Cell (0,5,utf8_decode('Información de solicitud TRK# '.utf8_decode($reg['serie'])),0,1,'C');

$pdf->Cell (35,10,'Fecha',1,0,'C',true);
$pdf->Cell (0,10,utf8_decode($reg['fecha']),1,1,'L');
$pdf->Cell (35,10,'Tracking ID',1,0,'C',true);
...
$pdf->cell(0,5,"TechSupport 2023",0,0,'C');
