<?php if($_SESSION['nombre']!="" && $_SESSION['tipo']=="admin"){ ?>    
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-2">
                <img src="./img/main/slider01.jpg" alt="Image" class="img-responsive animated flipInY">
            </div>
            <div class="col-sm-10">
              <p class="lead text-info">Bienvenido Administrador, A continuacion se mostrara los administradores y usuarios  registrados en TechSupport.</p>
            </div>
          </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            ...
                            <?php else: ?>
                                <h2 class="text-center">NO HAY ADMINISTRADORES EXISTENTES</h2>
                            <?php endif; ?>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-7 animated flip">
                    <h1 class="text-danger">Solo Administrador Autorizado</h1>
