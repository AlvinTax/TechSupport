       ...
       /* Actualizar cuenta admin */
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-9">
              <p class="lead text-info">Crear , eliminar y actualizar datos.</p>
            </div>
          </div><!--fin row-->
                  ...
                  <div class="row"> 
                      <div class="col-sm-12">
                        <div class="panel panel-danger">
                          ...
                          <div class="panel-body">
                              <center><img class="img-responsive" src="./img/main/slider01.jpg"></center><br>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                ...
                <img src="./img/tech6.png" alt="Image" class="img-responsive"/>
