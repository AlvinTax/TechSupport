        ...
        <div class="container">
          <div class="row well">
            ...
            <div class="col-sm-9 lead">
              <h2 class="text-info">Bienvenido a la configuración de cuenta TechSupport</h2>
              <p>Puedes <strong>actualizar los datos</strong> de tu cuenta ó puedes <strong>eliminar tu cuenta</strong> permanentemente si ya no deseas ser usuario de TechSupport</p>
            </div>
          </div><!--Fin row well-->
          ...
          <div class="row">
            ...
            <div class="col-sm-4 text-center well">
              ...
              <img src="img/tech6.png" alt="Image"><br><br><br>
