  ...
  if(MysqlQuery::Eliminar("ticket", "serie='$id'")){
    echo '
        <div class="alert alert-info alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
            ...
            <p class="text-center">
                El mantenimiento fue cancelado con exito!
            </p>
        </div>
    ';
  }else{
    echo '
        <div class="alert alert-danger alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
            ...
            <p class="text-center">
                Lo sentimos, no hemos podido cancelar su mantenimiento, intente de nuevo o contacte directamente con su tecnico!
            </p>
        </div>
    ';
  }
...
?>
        <div class="container">
            ...
            <div class="col-sm-10 lead text-justify">
              <h2 class="text-info">Estado del equipo en mantenimiento</h2>
              <p>con el <strong>Tracking ID </strong> Puede ver el estado de su mantenimiento en cualquier momento. GRACIAS POR PREFERIRNOS!</p>
            </div>
          </div><!--fin row well-->
          <div class="row">
              <div class="col-sm-12">
                    <div class="panel panel-success">
                        <div class="panel-heading text-center"><h4><i class="fa fa-ticket"></i> Tracking ID &nbsp;#<?php echo $lsT['serie']; ?></h4></div>
                      <div class="panel-body">
                          <div class="container">
                              <div class="col-sm-12">
                                  <div class="row">
                                      <div class="col-sm-4">
                                          <img class="img-responsive" alt="Image" src="img/tech4.png">
                                      </div>
                                      <div class="col-sm-8">
                                          <div class="row">
                                          ...
                                          <br>
                                          <div class="row">
                                              <div class="col-sm-6"><strong>Tecnicos Asignado:</strong> <?php echo $lsT['departamento']; ?></div>
                          ...
                          <div class="row">
                              ...
                              <div class="col-sm-6">
                                  <form action="" method="POST">
                                      ...
                                      <button class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span>&nbsp;  Cancelar Mantenimiento</button>
                                  </form>
                              </div>
                              <br class="hidden-lg hidden-md hidden-sm">
                              <div class="col-sm-6">
                                   <button id="save" class="btn btn-success" data-id="<?php echo $lsT['serie']; ?>"><span class="glyphicon glyphicon-floppy-disk"></span>&nbsp; Guardar como PDF</button>
                              </div>
                          </div>
                      </div>
                    </div>
        ...
        <div class="container">
            <div class="row  animated fadeInDownBig">
                ...
                <div class="col-sm-7 text-center">
                    ...
                    <h3 class="text-warning"><i class="fa fa-check"></i> El mantenimiento ha sido cancelado con exito!.</h3>
                    <h3 class="text-warning"><i class="fa fa-check"></i> Los datos ingresados no son correctos.</h3>
                    <br>
                    <h3 class="text-primary"> Por favor verifique que su <strong>Tracking ID</strong> y <strong>email</strong> sean correctos, e intente nuevamente.</h3>
