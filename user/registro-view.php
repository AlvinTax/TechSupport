<?php
    if(isset($_POST['user_reg']) && isset($_POST['clave_reg']) && isset($_POST['nom_complete_reg'])){
        ...
        $asunto="Registro de cuenta en TechSupport";
        $cabecera="From: TechSupport Guatemala<tech@umg.edu.gt>";
        $mensaje_mail="Hola ".$nombre_reg.", Gracias por registrarte en Tech Support Guatemala. Los datos de cuenta son los siguientes:\nNombre Completo: ".$nombre_reg."\nNombre de usuario: ".$user_reg."\nClave: ".$clave_reg2."\nEmail: ".$email_reg."\n Página principal: http://www.linuxstore.com/index.php";
        ...
        if(MysqlQuery::Guardar("cliente", "nombre_completo, nombre_usuario, email_cliente, clave", "'$nombre_reg', '$user_reg', '$email_reg', '$clave_reg'")){
            ...
            echo '
                <div class="alert alert-info alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    ...
                    <p class="text-center">
                        Cuenta creada exitosamente, ahora puedes iniciar sesión, ya eres usuario de TechSupport.
                    </p>
                </div>
            ';
        }else{
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-4 text-center hidden-xs">
      <img src="img/Tech1.png" class="img-responsive" alt="Image">
